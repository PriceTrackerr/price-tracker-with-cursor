              ...
              <div className="p-8">
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-600">
                    {isLogin ? "Sign in to your account" : "Start tracking prices today"}
                  </p>
                </div>
                ...
                <div className="space-y-3 mb-6">
                  <button 
                    className="w-full h-12 border border-gray-200 hover:bg-gray-50 transition-all duration-200 rounded-lg flex items-center justify-center gap-3 text-gray-700 font-medium"
                    type="button"
                  >
