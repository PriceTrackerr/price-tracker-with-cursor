...
const ProductCard: React.FC<{
  ...
  return (
    <div
      ...
      className={`product-card bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 overflow-hidden cursor-pointer hover:shadow-lg transition-all duration-200 ${highlighted ? 'highlighted-product' : ''
        }`}
