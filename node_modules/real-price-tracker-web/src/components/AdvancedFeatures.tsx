...
export default function AdvancedFeatures({ product }: AdvancedFeaturesProps) {
  ...
  const loadAdvancedFeatures = async () => {
    ...
    try {
      ...
      const enhancedResponse = await fetch(`http://localhost:3001/api/advanced/product-card-analysis/${product.id}`);
  ...
  const loadCouponStack = async () => {
    try {
      const response = await fetch(`http://localhost:3001/api/advanced/coupons/${product.id}`);
      if (response.ok) {
        const data = await response.json();
        setCouponStack({
  ...
  const loadGlobalComparison = async () => {
    try {
      const response = await fetch(`http://localhost:3001/api/advanced/global-arbitrage/${product.id}`);
      if (response.ok) {
        const data = await response.json();
        setGlobalComparison({
  ...
  const loadCommunityAnalysis = async () => {
    try {
      const response = await fetch(`http://localhost:3001/api/advanced/community-analysis/${product.id}`);
      if (response.ok) {
        const data = await response.json();
        setCommunityAnalysis({
