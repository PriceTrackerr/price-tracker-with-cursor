...
// Create Supabase client with service role key for admin operations when configured
...
// Create public client for user operations when configured
export const supabasePublic = configuredPublic
